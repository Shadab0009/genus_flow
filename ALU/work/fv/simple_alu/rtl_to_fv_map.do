...
# Generated on: Tue Jan 20 15:32:05 IST 2026 (Tue Jan 20 10:02:05 UTC 2026)
...
set logfile fv/simple_alu/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/simple_alu -revised fv_map
...
add_search_path . ../../LIB/Nangate45/ -library -both
read_library -liberty -both \
    /home/shadab/shadab/genus_flow/ALU/work/../../LIB/gsclib045_v3.5/timing/slow.lib \
    /home/shadab/shadab/genus_flow/ALU/work/../../LIB/gsclib045_v3.5/timing/fast.lib \
    /home/shadab/shadab/genus_flow/ALU/work/../../LIB/gsclib045_v3.5/timing/typical.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../simple_alu.v
elaborate_design -golden -root {simple_alu} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/simple_alu/fv_map.v.gz
elaborate_design -revised -root {simple_alu}
...
write_compared_points noneq.compared_points.simple_alu.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.simple_alu.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.simple_alu.rtl.fv_map.rpt
